...
package ru.whitebite.demo.advice;

import ru.whitebite.demo.exception.*;
import ru.whitebite.demo.model.payload.ApiResponse;
...
//    }
    ...
    @ResponseStatus(HttpStatus.EXPECTATION_FAILED)
    @ResponseBody
    public ApiResponse handleUserBlockedException(UserBlockedException ex, WebRequest request) {
        return new ApiResponse(false, ex.getMessage(), ex.getClass().getName(), resolvePathFromWebRequest(request));
    }
