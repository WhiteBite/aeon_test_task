...
package ru.whitebite.demo.security;

import ru.whitebite.demo.exception.UserBlockedException;
import ru.whitebite.demo.service.CustomUserDetailsService;
import ru.whitebite.demo.service.LoginAttemptService;
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response,
        ...
        try {
            ...
            if (loginAttemptService.isBlocked(clientIP)) {
                throw new UserBlockedException(clientIP);
            }
